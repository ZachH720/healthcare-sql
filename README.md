...
* Created a table in MySQL for the dataset to be imported into with an additional column for an auto-incremented ID.![Alt text]("C:\Users\zachh\PORTFOLIO\SQL\HEALTHCARE\create_table.png")
